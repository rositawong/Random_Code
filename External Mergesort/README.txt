...
I also include cout statements to better follow the program. Your output file will be output_file_*, dependent on number of merges completed
...
ASSUMPTIONS: 
- Each line of a file contains one name
- Each name is a maximum of 20 characters
- For the file with a list of files to merge, each line is one file name
- User can pass file names in command line arguments or pass a file containing the list of files to merge
...
- Merge sorted files and into one file 
	mergeFiles(): 
...
- Deletes intermediate output_file_*, and sub_file_*, etc generated
